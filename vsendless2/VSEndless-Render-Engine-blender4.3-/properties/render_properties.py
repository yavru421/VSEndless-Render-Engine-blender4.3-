...
logger = logging.getLogger("VSEndless.Props")

def register_properties():
    """Register all custom properties for VSEndless addon."""
    try:
        ...
        logger.info("VSEndless properties registered.")
    except (RuntimeError, ValueError, TypeError) as e:
        logger.error("Error registering VSEndless properties: %s", e)

def unregister_properties():
    """Unregister all custom properties for VSEndless addon."""
    try:
        ...
        logger.info("VSEndless properties unregistered.")
    except (RuntimeError, ValueError, TypeError) as e:
        logger.error("Error unregistering VSEndless properties: %s", e)
